 ...
 */
UCLASS()
class GRIDV1_API UCustomAbilitySystemComponent : public UAbilitySystemComponent
{
	GENERATED_BODY()
...
public:
	...
	AGridV1CharacterBase* GetCharacterBaseAvatar() const;
